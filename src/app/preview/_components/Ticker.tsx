...
async function buildTicks(): Promise<Tick[]> {
  ...
  return [
    ...
    { sym: 'BREADTH', v: '10 / 30', d: 'countries / cities', up: true, label: 'EU coverage' },
    { sym: 'MACRO', v: '60+', d: 'indicators', up: true, label: 'ECB / Eurostat' },
    { sym: 'AGENTS', v: '24 / 24', d: 'online', up: true, label: 'Swarm' },
    { sym: 'CRONS', v: '27', d: 'daily', up: true, label: 'Scheduled' },
