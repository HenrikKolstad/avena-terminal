...
const TIERS = [
  {
    ...
    period: '',
    requests: '100/day',
    features: ['Knowledge API', 'Market stats', 'Property search — Spain (10 results)', 'APCI index', 'APIP v1 format support'],
    cta: 'Get Free Key',
    highlight: false,
  },
  {
    ...
    period: '/mo',
    requests: '1,000/day',
    features: ['Everything in FREE', 'Multi-country search (PT, IT, NL, FR, DE)', 'Alpha signals', 'Yield curve data', 'Developer ratings', 'Email support'],
    cta: 'Subscribe',
    highlight: false,
  },
  {
    ...
    period: '/mo',
    requests: '10,000/day',
    features: ['Everything in STARTER', 'All 27 EU markets', 'AVM valuations', 'Scenario engine', 'Forecast model', 'Live macro indicators (ECB/Eurostat)', 'Webhook streams', 'Priority support'],
    cta: 'Subscribe',
    highlight: true,
  },
  {
    ...
    period: '/mo',
    requests: 'Unlimited',
    features: ['Everything in PRO', 'Federated network access', 'Bank AVM assessment', 'Data licensing (CC BY 4.0+)', 'White-label feeds', 'APIP v1 standard export', 'Custom models', 'SLA guarantee', 'Dedicated account'],
    cta: 'Subscribe',
    highlight: false,
  },
];
