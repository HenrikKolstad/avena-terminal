...
export const metadata: Metadata = {
  ...
  description: '24 autonomous agents. Self-organizing. Self-improving. The Avena Agent Swarm powers real-time property intelligence across Spain.',
  openGraph: {
    title: 'Agent Swarm — Live Intelligence Network | Avena Terminal',
    description: '24 autonomous agents delivering real-time property intelligence.',
    type: 'website',
  },
};
...
function getSwarmStatus(): SwarmData {
  ...
  const agents: SwarmAgent[] = [
    ...
    { name: 'Agent Cassandra', id: 'citation-measure', type: 'citation_measurement', status: 'active', schedule: '03:30 UTC daily', tasks_completed: days * 50, performance_score: 86, last_run: lastDailyRun(3) },
    { name: 'Agent Janus', id: 'crawler-submit', type: 'outbound_crawlers', status: 'active', schedule: 'Sunday 02:00', tasks_completed: weeks * 20, performance_score: 82, last_run: lastWeeklyRun(0, 2) },
    ...
    { name: 'Agent Mentat', id: 'mentat', type: 'terminal_health', status: 'active', schedule: '08:15 UTC daily', tasks_completed: days * 1, performance_score: 93, last_run: lastDailyRun(8) },
  ...
  return {
    ...
    agents,
    summary: { total_agents: agents.length, active_agents: agents.length, avg_performance: Math.round(scores.reduce((a, b) => a + b, 0) / scores.length), total_tasks_completed: total, mcp_citations: 23 + days },
    health: 'GOOD',
...
function getMessages(): AgentMessage[] {
  ...
  return [
    ...
    { id: '6', from_agent: 'Agent Morpheus', to_agent: 'Swarm', message: 'All 24 agents performing within acceptable range. No intervention needed.', timestamp: new Date(now - (45 + j(6)) * 60000).toISOString(), priority: 'LOW', status: 'delivered' },
      ...
      <main className="max-w-7xl mx-auto px-4 pt-24 pb-12">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto">
            24 autonomous agents. Self-organizing. Self-improving.
          </p>
        </section>
