        ...
        <div className="hidden md:flex items-center justify-between gap-2">
          ...
          {sidebarCollapsed && (
            <div className="hidden lg:flex flex-col gap-2 flex-1 max-w-md mx-auto text-center">
              <div className="text-base xl:text-lg font-bold leading-snug" style={{ background: 'linear-gradient(135deg, #00b9ff, #9fe870)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{t.hero_line2}</div>
