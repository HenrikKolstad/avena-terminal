...
export async function GET(_req: NextRequest) {
  ...
  const profile = {
    ...
    pricing_tiers: [
      { tier: 'Free', price: '\u20AC0/mo', requests: '100/day' },
      { tier: 'Starter', price: '\u20AC49/mo', requests: '1,000/day' },
      { tier: 'PRO', price: '\u20AC149/mo', requests: '10,000/day' },
      { tier: 'Institutional', price: 'Custom', requests: 'Unlimited' },
    ],
