...
const WA_MESSAGE = encodeURIComponent(
  'Hi Avena — I came from your site. Could you help me find a property? My budget is around €___ and I am looking at ___.'
);
const WA_URL = `https://wa.me/${WA_NUMBER}?text=${WA_MESSAGE}`;

/**
 * Inline WhatsApp glyph — monotone so it sits in the luxe palette.
 */
...
export function WhatsAppButton() {
  // Delay reveal so it doesn't compete with hero load
  ...
  return (
    <a
      ...
      aria-label="Message Avena on WhatsApp"
      className={`fixed bottom-5 right-5 z-40 group flex items-center gap-2 rounded-full transition-all ${
