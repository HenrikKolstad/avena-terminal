...
const NAV: TopItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Time Travel',        href: '/timetravel',          sub: 'Replay Avena at any historical moment · event-sourced' },
      ...
      { label: 'Regulatory Radar',   href: '/regulatory-radar',    sub: 'EU regulatory signals classified for property impact' },
      { label: 'Causal Graph',       href: '/causal-graph',        sub: 'Typed dependency map · coefficients · lag estimates' },
      { label: 'Limitations',        href: '/limitations',         sub: 'What Avena does not know · daily, self-generated' },
      ...
      { label: 'Contribute Data',    href: '/contribute',          sub: 'Onramp for notaries, brokers, registries, agencies, funds' },
