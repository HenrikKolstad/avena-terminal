...
const NAV: TopItem[] = [
  ...
  { label: 'Deals', href: '/#deals' },
  {
    ...
    children: [
      ...
      { label: 'AVN-ID',        href: '/avn-id',      sub: 'ISIN for European property · signed registry' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Webhooks',           href: '/docs/webhooks',            sub: 'Signed event push · anomalies · briefings · AVN-IDs' },
      { label: 'Wikidata Q139165733',href: '/wikidata',                 sub: 'Structured claim graph · QuickStatements export' },
