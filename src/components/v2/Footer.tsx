...
const columns: { heading: string; links: { label: string; href: string }[] }[] = [
  {
    ...
    links: [
      ...
      { label: 'Compare towns',   href: '/compare' },
      { label: 'How it works',    href: '/how-it-works' },
      { label: 'Enquire',         href: '/enquire' },
      { label: 'Buying guides',   href: '/answers' },
      { label: 'For norske kjøpere', href: '/no' },
  ...
  },
  {
    heading: 'The Engine',
    links: [
      { label: 'The Avena Engine', href: '/engine' },
      ...
      { label: 'Standards (APIP)', href: '/standards' },
    ],
  },
  {
    heading: 'Institutions & builders',
    links: [
      { label: 'API',             href: '/api' },
