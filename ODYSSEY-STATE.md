...
| Live book | **2,033 listings** (09-11 feed, second refresh committed 09:34). **Today's 09-12 feed had NOT landed at 05:50 — no GitHub Actions run existed yet, and `pricing-history` correctly reported `skipped / overdue:false`. Inside the normal O-61 window; a 07:05 self check-in is armed** | 2026-09-12 (pre-run) | `public/data.json`, `feed-meta.json` |
...
| Snapshot rows by day | 2,026 (09-05), 2,034 (09-06), 2,034 (09-07), **2,037 (09-08)**, **2,037 (09-09 — union day)**, **2,036 (09-10)**, **2,035 (09-11 — TWO writes, UNION DAY, corrected from yesterday's 2,033; final book 2,033)**. **TWENTY consecutive days captured through 09-11, no gap; 09-12 pending** | 2026-09-12 | `price_snapshots` |
